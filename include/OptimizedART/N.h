 ...
 */
    ...
    class N {
    protected:
        N(NTypes type, const uint8_t *prefix, uint32_t prefixLength, uint32_t matchLevel) {
            setType(type);
    ...
    public:
        ...
        uint32_t getMatchLevel();

        void setMatchLevel(uint32_t newMatchLevel);
    ...
    public:
        N4(const uint8_t *prefix, uint32_t prefixLength, uint32_t matchLevel) : N(NTypes::N4, prefix,
    ...
    public:
        N16(const uint8_t *prefix, uint32_t prefixLength, uint32_t matchLevel) : N(NTypes::N16, prefix,
                                                              prefixLength, matchLevel) {
    ...
    public:
        ...
        N48(const uint8_t *prefix, uint32_t prefixLength, uint32_t matchLevel) : N(NTypes::N48, prefix,
                                                              prefixLength, matchLevel) {
    ...
    public:
        N256(const uint8_t *prefix, uint32_t prefixLength, uint32_t matchLevel) : N(NTypes::N256, prefix,
                                                               prefixLength, matchLevel) {
            memset(children, '\0', sizeof(children));
        }
